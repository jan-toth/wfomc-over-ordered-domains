...
# English & Math Books
loop_with_timeout "uv run auto_counter.py -inc -l inc2 -ee 2 -o books.csv" $(ls -v ../models/seq/eng_math/new_encode/*.wfomcs)
loop_with_timeout "uv run auto_counter.py -inc -ee 2 -o books.csv" $(ls -v ../models/seq/eng_math/old_encode/*.wfomcs)
...
loop_with_timeout "uv run auto_counter.py -inc -l inc2 -ee 2 -o combinatorics.csv" $(ls -v ../models/comb/original/new_encode/*.wfomcs)
loop_with_timeout "uv run auto_counter.py -inc -ee 2 -o combinatorics.csv" $(ls -v ../models/comb/original/old_encode/*.wfomcs)
loop_with_timeout "uv run auto_counter.py -rec -o combinatorics.csv" $(ls -v ../models/comb/original/old_encode/*.wfomcs)
loop_with_timeout "uv run auto_counter.py -ganak -o combinatorics.csv" $(ls -v ../models/comb/original/cnf/*.cnf)
loop_with_timeout "uv run auto_counter.py -d4 -o combinatorics.csv" $(ls -v ../models/comb/original/cnf/*.cnf)

# Twice the domain
loop_with_timeout "uv run auto_counter.py -inc -l inc2 -ee 2 -o combinatorics.csv" $(ls -v ../models/comb/times_2/new_encode/*.wfomcs)
loop_with_timeout "uv run auto_counter.py -ganak -o combinatorics.csv" $(ls -v ../models/comb/times_2/cnf/*.cnf)
loop_with_timeout "uv run auto_counter.py -d4 -o combinatorics.csv" $(ls -v ../models/comb/times_2/cnf/*.cnf)
...
# Standard HMMs
loop_with_timeout "uv run auto_counter.py -inc -l inc2 -ee 2 -o hmm.csv" $(ls -v ../models/weather2/new_encode/*.mln)
...
loop_with_timeout "uv run auto_counter.py -inc -l inc2 -ee 2 -o higher_hmm.csv" $(ls -v ../models/weather/new_encode/*.mln)
...
loop_with_timeout "uv run auto_counter.py -inc -l inc2 -ee 2 -o ws.csv" $(ls -v ../models/ws/new_encode/*.wfomcs)
