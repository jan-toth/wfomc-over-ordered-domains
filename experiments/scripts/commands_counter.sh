...
loop_with_timeout "uv run auto_counter.py -lops -o lops_p1.csv" $(ls -v ../models/lops/p1/wfomcs/*.wfomcs)
loop_with_timeout "uv run auto_counter.py -ganak -o lops_p1.csv" $(ls -v ../models/lops/p1/cnf/*.cnf)
loop_with_timeout "uv run auto_counter.py -d4 -o lops_p1.csv" $(ls -v ../models/lops/p1/cnf/*.cnf)

loop_with_timeout "uv run auto_counter.py -lops -o lops_p2.csv" $(ls -v ../models/lops/p2/wfomcs/*.wfomcs)
loop_with_timeout "uv run auto_counter.py -ganak -o lops_p2.csv" $(ls -v ../models/lops/p2/cnf/*.cnf)
loop_with_timeout "uv run auto_counter.py -d4 -o lops_p2.csv" $(ls -v ../models/lops/p2/cnf/*.cnf)

loop_with_timeout "uv run auto_counter.py -lops -o lops_p4.csv" $(ls -v ../models/lops/p4/wfomcs/*.wfomcs)
loop_with_timeout "uv run auto_counter.py -ganak -o lops_p4.csv" $(ls -v ../models/lops/p4/cnf/*.cnf)
loop_with_timeout "uv run auto_counter.py -d4 -o lops_p4.csv" $(ls -v ../models/lops/p4/cnf/*.cnf)

loop_with_timeout "uv run auto_counter.py -lops -o lops_p5.csv" $(ls -v ../models/lops/p5/wfomcs/*.wfomcs)
loop_with_timeout "uv run auto_counter.py -ganak -o lops_p5.csv" $(ls -v ../models/lops/p5/cnf/*.cnf)
loop_with_timeout "uv run auto_counter.py -d4 -o lops_p5.csv" $(ls -v ../models/lops/p5/cnf/*.cnf)
